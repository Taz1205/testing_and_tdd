...
describe("returns scores for a bowling game based on the rolls input", () => {
  ...
  test("returns score 300 when all 12 rolls are strikes", () => {
    expect(
      bowlingGame(["X", "X", "X", "X", "X", "X", "X", "X", "X", "X", "X", "X"])
    ).toEqual(300);
  });
  test("returns score 145 when all rolls are spares", () => {
    expect(
      bowlingGame([
        "5",
        "/",
  ...
  test("returns score 72 when there are mix of strikes and spares", () => {
    expect(
      bowlingGame([
        "3",
        "1",
  ...
  test("returns score 87 when there are mix of strikes and spares", () => {
    expect(
      bowlingGame([
        "2",
        "1",
